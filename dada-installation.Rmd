...
Binary installation is available through [the Bioconductor package repository](https://bioconductor.org/). Binary installation of the current version of the dada2 package (1.8) requires R 3.5.0 and Bioconductor version 3.7:
...
*If the above installed an early version of dada2 (e.g. 1.4 or 1.6) you can get the current dada2 release by updating to [Bioconductor 3.7](https://bioconductor.org/news/bioc_3_7_release/): `biocLite("BiocUpgrade")` then `biocLite()`. This may require updating R as well.*
...
* Development Branch [(1.8)](https://github.com/benjjneb/dada2): [Zipped](https://github.com/benjjneb/dada2/archive/master.zip) or [tarball](https://github.com/benjjneb/dada2/archive/master.tar.gz).
