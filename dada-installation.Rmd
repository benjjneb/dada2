...
Binary installation is available through the Bioconductor package repository. Binary installation of the current version of the dada2 package (1.4) requires R 3.4:
...
*If the above installed an early version of dada2 (1.0 or 1.2) you can get the current dada2 release by updating your Bioconductor installation to version 3.5: `biocLite("BiocUpgrade")` then `biocLite()`*

-----------------------------

## **Install from source**

Source installation is available for R3.2 or later, and the latest and greatest features will be available first through source installs of the development branch.

### 0. Download

* Current Release [(1.4)](https://github.com/benjjneb/dada2/releases): [Zipped](https://github.com/benjjneb/dada2/archive/v1.4.zip) or [tarball](https://github.com/benjjneb/dada2/archive/v1.4.tar.gz).

* Development Branch [(1.5)](https://github.com/benjjneb/dada2): [Zipped](https://github.com/benjjneb/dada2/archive/master.zip) or [tarball](https://github.com/benjjneb/dada2/archive/master.tar.gz).
