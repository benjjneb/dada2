...
Binary installation is available through the Bioconductor package repository. Currently, **binary installation is only supported for the current release and  R version 3.3 and later**.
