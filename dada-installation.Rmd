...
Binary installation of the current release version (1.10) requires R 3.5.0 and Bioconductor version 3.8:
...
*If the above installed an early version of dada2 (e.g. 1.4 or 1.6) you can get the current dada2 release by updating to [Bioconductor 3.8](https://www.bioconductor.org/news/bioc_3_8_release/). This may require updating R as well.*
