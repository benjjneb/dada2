...
Binary installation of the current release version (1.8) requires R 3.5.0 and Bioconductor version 3.7:
...
* Current Release [(1.8)](https://github.com/benjjneb/dada2/releases): [Zipped](https://github.com/benjjneb/dada2/archive/v1.8.zip) or [tarball](https://github.com/benjjneb/dada2/archive/v1.8.tar.gz).

* Development Branch [(1.9)](https://github.com/benjjneb/dada2): [Zipped](https://github.com/benjjneb/dada2/archive/master.zip) or [tarball](https://github.com/benjjneb/dada2/archive/master.tar.gz).
