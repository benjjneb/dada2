...
Binary installation of the current release version (1.36) requires R 4.5.0 and Bioconductor version 3.21:
...
*If the above installed an early version of dada2 (e.g. 1.10 or 1.14) you can get the current dada2 release by updating to [Bioconductor 3.21](https://bioconductor.org/news/bioc_3_21_release/). This may require updating to R 4.5.0 as well.*
...
* Current Release [(1.36)](https://bioconductor.org/packages/release/bioc/html/dada2.html#archives): [Tarball](https://bioconductor.org/packages/release/bioc/src/contrib/dada2_1.36.0.tar.gz).

* Development Branch [(1.37)](https://code.bioconductor.org/browse/dada2/devel/): [Tarball](https://bioconductor.org/packages/devel/bioc/src/contrib/dada2_1.37.0.tar.gz).
...
if (!require("BiocManager", quietly = TRUE))
    install.packages("BiocManager")
BiocManager::install("ShortRead", version = "3.21")
