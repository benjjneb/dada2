...
Binary installation is available through the Bioconductor package repository. Currently, **binary installation is only supported for the current release version of dada2, and only on  R 3.3 and later**.
