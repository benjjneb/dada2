...
Binary installation of the current release version (1.12) requires R 3.6.0 and Bioconductor version 3.9:
...
*If the above installed an early version of dada2 (e.g. 1.6 or 1.10) you can get the current dada2 release by updating to [Bioconductor 3.9](https://www.bioconductor.org/news/bioc_3_9_release/). This may require updating to R 3.6.0 as well.*
...
* Current Release [(1.12)](https://github.com/benjjneb/dada2/releases): [Zipped](https://github.com/benjjneb/dada2/archive/v1.12.zip) or [tarball](https://github.com/benjjneb/dada2/archive/v1.12.tar.gz).

* Development Branch [(1.13)](https://github.com/benjjneb/dada2): [Zipped](https://github.com/benjjneb/dada2/archive/master.zip) or [tarball](https://github.com/benjjneb/dada2/archive/master.tar.gz).
...
BiocManager::install("additional_missing_package_1", version = "3.9") 
# ... and so on
```
