...
*This workflow takes advantage of functionality added in the 1.4 release. The [workflow for the earlier 1.2 version of the dada2 R package](big_dada_1_2.html) is also available.*
...
*These issues are discussed in more detail in our open-access ISMEJ paper ["Exact sequence variants should replace operational taxonomic units in marker gene data analysis"](http://dx.doi.org/10.1038/ismej.2017.119)*.
