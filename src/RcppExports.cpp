...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(C_is_bimera(sq, pars, allow_one_off, min_one_off_par_dist, score, gap_p, max_shift));
    return rcpp_result_gen;
END_RCPP
}
// C_nwalign
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(C_nwalign(s1, s2, score, gap_p, homo_gap_p, band, endsfree));
    return rcpp_result_gen;
END_RCPP
}
// C_eval_pair
