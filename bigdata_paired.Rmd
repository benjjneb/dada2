---
title: 'A DADA2 workflow for Big Data: Paired-end'
...
The workflow below expects demultiplexed, per-sample, gzipped fastq files for the forward reads of a Hiseq run to be in the directory `pathF` (defined below), and the corresponding reverse read files to be in a different directory `pathR`. The string parsing below expects forward and reverse filenames of the following format: `samplename_XXX.fastq.gz`, but other formats simply require modification to the filename parsing portions of these scripts.
...
pathF <- "~/Desktop/ptest/FWD" ###!
pathR <- "~/Desktop/ptest/REV" ###!
...
NSAM.LEARN <- 20 # Choose enough samples to have at least 1M reads ###!
