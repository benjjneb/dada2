...
dada_uniques <- function(seqs, abundances, err, quals, match, mismatch, gap, use_kmers, kdist_cutoff, band_size, omegaA, max_clust, min_fold, min_hamming, min_abund, use_quals, final_consensus, vectorized_alignment, homo_gap, multithread, verbose, SSE, gapless) {
    .Call('_dada2_dada_uniques', PACKAGE = 'dada2', seqs, abundances, err, quals, match, mismatch, gap, use_kmers, kdist_cutoff, band_size, omegaA, max_clust, min_fold, min_hamming, min_abund, use_quals, final_consensus, vectorized_alignment, homo_gap, multithread, verbose, SSE, gapless)
}
