...
**<span style="color:red">The DADA2 1.36 release is live, with improvements to error rate calculations and taxonomic assignment. [Release notes](ReleaseNotes_1_36.html).</span>**

--------------------------

## Installation

Binaries for the current release version of DADA2 (1.36) are available from Bioconductor. Note that you must have R 4.5.0 or newer, and [Bioconductor version 3.21](https://www.bioconductor.org/install/), to install the most current release from Bioconductor.
