&nbsp;
<center>
![The DADA2 R package](images/DADA2_Logo_Text_1_8_640.png)
</center>
...
####**<span style="color:red">DADA2 + PacBio is live in version 1.9.1<br>
[High-throughput amplicon sequencing of the full-length 16S rRNA gene with single-nucleotide resolution](https://www.biorxiv.org/content/early/2018/08/15/392332)</span>**

&nbsp;

## Installation

Binaries for the current release version of DADA2 (1.8) are available from Bioconductor. Note that you must have R 3.5.0 or newer, and [Biocondcutor version 3.7](https://www.bioconductor.org/install/), to install the current release from Bioconductor.
