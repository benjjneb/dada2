&nbsp;
<center>
![The DADA2 R package](images/DADA2_Logo_Text_1_14_640px.png)
</center>
...
**<span style="color:red">The DADA2 1.14 release is live, with support for fastq directories and reads up to 9999nts, and a new tool to use (with caution) to detect the rarest variants! See [the release notes](ReleaseNotes_1_14.html).</span>**
