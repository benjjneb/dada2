...
Binaries for the current release version of DADA2 (1.4) are available from Bioconductor (note that you must have R 3.4.0 or newer, and [Biocondcutor version 3.5](https://www.bioconductor.org/install/), to install the current release from Bioconductor):
...
Our [manuscript](http://dx.doi.org/10.1038/nmeth.3869) ([OA link](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4927377/)) compares the accuracy of DADA2 and other methods on several mock community datasets. 

Further [benchmarking of DADA2 against the methods evaluated in a recent QIIME1 benchmarking paper](SotA.html) is available.

We describe [the broad advantages of exact sequence variants over OTUs in a recent preprint](http://www.biorxiv.org/content/early/2017/03/07/113597).
...
* **High Resolution**: DADA2 infers exact sequence variants from amplicon data, resolving differences of even 1 or 2 nucleotides.
