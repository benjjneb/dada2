&nbsp;
<center>
![The DADA2 R package](images/DADA2_Logo_640.png)
</center>
...
####**<span style="color:red">Higher sensitivity to rare variants via [priors and pseudo-pooling](pseudo.html) introduced in dada2 version 1.8.</span>**

&nbsp;

## Installation

Binaries for the current release version of DADA2 (1.6) are available from Bioconductor. Note that you must have R 3.4.2 or newer, and [Biocondcutor version 3.6](https://www.bioconductor.org/install/), to install the current release from Bioconductor.
