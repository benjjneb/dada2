...
Installation instructions are available on the DADA2 website.

### Tutorial

A walkthrough of the DADA2 pipeline for paired end Illumina Miseq data is available on the DADA2 website.
