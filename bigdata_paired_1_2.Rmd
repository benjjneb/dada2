...
**<span style="color:red">A version of this workflow [for versions 1.4 and later](bigdata.html) is also available. More discussion of the computational strategy of the big data workflow is available in [the single-read version](bigdata_1_2.html).**
